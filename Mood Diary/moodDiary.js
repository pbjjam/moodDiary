//Jeong Hyo Kang - Mood Diary Entry Function
window.addEventListener('load', function() {
    ...
    let entry = document.querySelector('#diaryEntry');
    let login_button = document.querySelector('#loginButton');
    let login_info = document.querySelector('#loginInfo');
    let image = document.querySelector('#image');
    let image_input = document.querySelector('#dailyImage');
    ...
    login_button.addEventListener('click', function() {
        login_info.style.display = (login_info.style.display === 'block') ? 'none' : 'block';
